    ...
    <div className="container mx-auto">
      <div className="row">
        <div className="col-5">
          ...
          />
            ...
            {filteredData.length === 0 ? (
              ...
              <button className='btn btn-warning' onClick={clearInput} >Limpiar</button>
            )}
        </div>
        ...
        <div className="col-7">
          ...
          <hr />
          {filteredData.length !== 0 && (
          <div className='table table-borderles'
            style={{ display: showSearch ? '' : 'none' }}>
            <tr className="border-bottom">
              <td className='px-2'><b>Correo</b></td>
              <td className='px-2'><b>Departamento</b></td>
              <td className='px-2'><b>Tipo de Solicitud</b></td>
              <td className='px-2'><b>Fecha de Inicio</b></td>
            </tr>
